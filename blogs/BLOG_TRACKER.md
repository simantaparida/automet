...
Track all blog posts across different stages.

## Status Legend
- 📝 **Draft** - Being written
- ✅ **Ready** - SQL generated, ready to upload
- 🚀 **Uploaded** - Live in database
- 📦 **Archived** - Uploaded and archived

---

## Blog Posts

### Series: Field Service Management Fundamentals

| # | Title | Status | Category | Word Count | Date Created | Date Uploaded |
|---|-------|--------|----------|------------|--------------|---------------|
...
- [ ] Complete Guide to Technician Tracking
- [ ] Digital Transformation for Small Contractors
...
- Focus: SEO-driven educational content
- Mix: 50% global, 50% India-specific
- Length: 1,500-5,000 words for pillar content
