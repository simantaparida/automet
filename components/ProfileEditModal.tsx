...
export default function ProfileEditModal({
    ...
    const [contactPhone, setContactPhone] = useState(currentProfile.contact_phone || '');
    const [profilePhoto, setProfilePhoto] = useState<string | null>(currentProfile.profile_photo_url || null);
    const [saving, setSaving] = useState(false);
    const [errors, setErrors] = useState<{ fullName?: string; contactPhone?: string }>({});
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed ${errors.fullName ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                    }`}
                            />
                        </div>
                        {errors.fullName && (
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className={`w-full pl-10 pr-4 py-3 border-2 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-primary/20 focus:border-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed ${errors.contactPhone ? 'border-red-300 bg-red-50' : 'border-gray-200'
                                    }`}
                            />
                        </div>
                        {errors.contactPhone && (
