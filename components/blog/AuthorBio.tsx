...
export default function AuthorBio({
  ...
  const bio =
    authorBio ||
    `${authorName} is a ${authorRole} at Automet, helping AMC businesses optimize their field service operations through insightful content and best practices.`;
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-start">
        ...
        <div className="flex-1 min-w-0">
          <div className="mb-2">
            ...
            <p className="text-sm text-gray-600 font-medium">{authorRole}</p>
          </div>
