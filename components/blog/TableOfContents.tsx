...
export default function TableOfContents({ content, minWords = 1500 }: TableOfContentsProps) {
          ...
          <div className="mt-6 pt-6 border-t border-gray-200">
            ...
            <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
              <div 
                ...
                style={{ 
                  width: `${Math.min((headings.findIndex(h => h.id === activeId) + 1) / headings.length * 100, 100)}%` 
                }}
              />
            </div>
          </div>
