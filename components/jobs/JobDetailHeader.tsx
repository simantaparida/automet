    ...
    <div className="mb-8">
      ...
      <div className="bg-gradient-to-br from-white via-white to-gray-50 rounded-2xl border border-gray-200/60 shadow-lg shadow-gray-200/40 overflow-hidden backdrop-blur-sm">
        ...
        {priorityConfig.pulse && (
          <div
            className={`h-1.5 bg-gradient-to-r ${statusConfig.gradient} animate-pulse`}
          ></div>
        )}
        ...
        <div className="p-4 md:p-6">
          ...
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4 mb-4">
            <div className="flex-1">
              <div className="flex items-start gap-3 mb-2">
                ...
                <div
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold uppercase tracking-wider ${priorityConfig.bg} ${priorityConfig.color} shadow-sm`}
                >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            ...
            <div className="flex items-center gap-3 p-3 bg-white/80 rounded-xl border border-gray-200/60 shadow-sm">
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center ${statusConfig.bg} ${statusConfig.color} shadow-sm`}
              >
            ...
            <div className="flex items-center gap-3 p-3 bg-white/80 rounded-xl border border-gray-200/60 shadow-sm">
              <div
                className={`w-10 h-10 rounded-xl flex items-center justify-center ${isOverdue ? 'bg-red-50 text-red-600' : 'bg-blue-50 text-blue-600'} shadow-sm`}
              >
              ...
              <div>
                ...
                <div
                  className={`text-xs font-medium ${isOverdue ? 'text-red-500' : 'text-gray-500'}`}
                >
            ...
            <div className="flex items-center gap-3 p-4 bg-red-50 border-l-4 border-red-500 rounded-lg">
              ...
              <div>
                ...
                <div className="text-xs text-red-700">
                  Scheduled for {formatDate(job.scheduled_at)}
                </div>
              </div>
            </div>
          )}
