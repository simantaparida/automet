  ...
  const features = [
    {
      ...
      description: 'Store all client details, multiple sites per client, and asset information.',
      description2: 'Organized, searchable, and always accessible.',
    },
    {
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: 'Understand your business with clear insights on revenue and performance.',
      description2: 'Track job completion rates and technician efficiency.',
    },
  ];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
          {features.map((feature, index) => {
            ...
            const bgClass = isEvenRow ? 'bg-gray-50' : 'bg-white';
