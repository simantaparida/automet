      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center animate-fade-in">
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-gray-900 mb-6 leading-tight">
            Stop losing 10% revenue to manual processes. Get paid 5x faster with Automet.
          </h1>
          ...
          <p className="text-lg sm:text-xl lg:text-2xl text-gray-600 mb-8 leading-relaxed">
            ...
            <span className="text-primary font-semibold">Everything in one place. Finally.</span>
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6 text-sm text-gray-600">
            {waitlistCount && (
              <div className="flex items-center">
                ...
                <span className="font-semibold text-primary">{waitlistCount}+</span> AMC vendors already joined
              </div>
            )}
            <div className="flex items-center">
              <svg className="w-5 h-5 text-primary mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
