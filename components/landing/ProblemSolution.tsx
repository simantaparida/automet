...
export default function ProblemSolution({ onPreorderClick }: ProblemSolutionProps) {
  // Reduced to 3 key pain points (most impactful)
  const comparisons = [
    {
      problem: {
        title: 'Paperwork Chaos',
        description: 'Job sheets scattered everywhere. Service reports in WhatsApp. No central record.',
        icon: (
      ...
      solution: {
        ...
        description: 'All jobs, clients, and reports organized in one dashboard. Find anything in seconds.',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      problem: {
        ...
        description: 'Where is Raju? Did Suresh complete the job? Endless calls and WhatsApp messages.',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      solution: {
        ...
        description: 'See who\'s where, what they\'re working on, and job status in real-time. No more guessing.',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      problem: {
        ...
        description: 'Manual invoices. Follow-ups taking days. Missing paperwork. 5% revenue lost to slow collections.',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      solution: {
        ...
        description: 'Auto-generate invoices instantly. Send payment links via SMS. Accept UPI, cards, net banking.',
        icon: (
          <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-base text-gray-600">
            See how Automet solves the biggest pain points for Indian AMC vendors
          </p>
        </div>
