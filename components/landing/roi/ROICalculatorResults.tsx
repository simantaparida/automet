  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        {/* Net Monthly Benefit */}
        <div
          className={`bg-gradient-to-br rounded-xl p-5 border-2 hover:shadow-lg transition-all ${
            isPositiveROI
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-700">
                With current inputs, the plan cost exceeds calculated savings.
                Try adjusting parameters or consider a lower-tier plan.
              </p>
            </div>
          </div>
        </div>
