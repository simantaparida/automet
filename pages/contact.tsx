          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="mt-6 text-lg sm:text-xl text-gray-600 leading-relaxed">
                Whether you&apos;re evaluating job tracking software or already
                on the waitlist, our founding team is hands-on. Expect honest
                guidance, local context, and fast follow-ups.
              </p>
                ...
                <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-full shadow-sm border border-primary/20">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M15.172 7l-6.586 6.586a2 2 0 102.828 2.828L18 9.828M5 5l14 14"
                    />
                  </svg>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="mt-3 text-lg text-gray-600">
                    Speak with founders, customer success, or implementation
                    experts. We respond during business hours and monitor
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div className="w-12 h-12 rounded-xl bg-primary/10 text-primary flex items-center justify-center mb-4">
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.163 21 3 14.837 3 7V5z"
                        />
                      </svg>
                    </div>
                  ...
                  <div className="p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-primary/40 transition-all duration-300">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      Tap to open a secure WhatsApp chat
                    </p>
                  </div>
                  ...
                  <div className="p-6 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg hover:border-primary/40 transition-all duration-300">
                    ...
                    <p className="text-lg font-semibold text-gray-900 leading-relaxed">
                      ...
                      <br />
                      Karnataka, India{' '}
                      <span className="text-gray-500">560078</span>
                    </p>
                    <Link
                ...
                <div className="p-6 rounded-2xl border border-primary/30 bg-primary/5">
                  ...
                  <ul className="mt-4 space-y-3 text-sm text-gray-700">
                    <li className="flex items-start gap-2">
                      ...
                      We triage every message manually—no chatbots, no
                      outsourcing.
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary" />
                    ...
                    <li className="flex items-start gap-2">
                      <span className="mt-1 h-2.5 w-2.5 rounded-full bg-primary" />
                      Security or data concerns go straight to the engineering
                      team.
                    </li>
                  </ul>
                </div>
                ...
                <div className="rounded-3xl border border-gray-200 bg-white shadow-xl overflow-hidden">
                  <div className="p-6 border-b border-gray-200">
                    ...
                    <p className="mt-2 text-sm text-gray-600">
                      We&apos;re available for scheduled meetings and pilot
                      workshops. Call or WhatsApp us before dropping by so we
                      can host you properly.
                    </p>
                  </div>
                  <iframe
                ...
                <div className="rounded-3xl border border-gray-200 bg-white shadow-lg p-6">
                  ...
                  <dl className="mt-4 space-y-4 text-sm text-gray-600">
                    ...
                    <div className="flex justify-between">
                      ...
                      <dd>
                        Automet Technologies Pvt. Ltd. (pre-incorporation)
                      </dd>
                    </div>
                  </dl>
          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto text-center bg-white/70 backdrop-blur rounded-3xl border border-primary/20 p-10 shadow-xl">
              ...
              <p className="mt-4 text-lg text-gray-600">
                Share a few details about your organisation and we&apos;ll set
                up a personalised walkthrough of Automet—tailored to your
                service workflows.
              </p>
