  ...
  useEffect(() => {
    const loadSummary = async () => {
      ...
      try {
        ...
        setSummary({
          organizationName:
            (userData.organizations as any)?.name || 'Your Organization',
          ...
          >
            ...
            <div
              style={{
                ...
                animation: isAnimating ? 'pulse 2s 0.5s infinite' : 'none',
              }}
            />
          </div>
            ...
            <button
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  '0 6px 20px rgba(239,119,34,0.4)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.transform = 'translateY(0)';
                e.currentTarget.style.boxShadow =
                  '0 4px 14px rgba(239,119,34,0.35)';
              }}
            >
              Go to Dashboard →
            </button>
