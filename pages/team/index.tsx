                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {members.map((member) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <span
                                  className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full border ${getRoleBadgeColor(member.role)}`}
                                >
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                          {invites.map((invite) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-4 whitespace-nowrap">
                                <span
                                  className={`px-2 inline-flex text-xs leading-5 font-semibold rounded-full border ${getRoleBadgeColor(invite.role)}`}
                                >
                      ...
                      <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                        ...
                        <div className="mt-4 space-y-4">
                          ...
                          <div className="grid grid-cols-1 gap-3">
                            {['owner', 'coordinator', 'technician'].map(
                              (role) => (
                                <button
                                  key={role}
                                  onClick={() =>
