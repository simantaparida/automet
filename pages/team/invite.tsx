                    ...
                    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                        ...
                        <div className="bg-white shadow-sm rounded-lg border border-gray-200 overflow-hidden">
                            <div className="px-6 py-4 border-b border-gray-200 bg-gray-50">
                                <h1 className="text-xl font-bold text-gray-900">Invite New Member</h1>
                                ...
                                {success ? (
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-gray-500 mt-2">
                                            We've sent an email to <strong>{formData.email}</strong> with instructions to join.
                                        </p>
                                        <p className="text-sm text-gray-400 mt-4">Redirecting to team list...</p>
                                    </div>
                                ) : (
